module.exports = {
  siteTitle: 'Elizabethseaside',
  siteTitleAlt: 'Elizabethseaside portfolio', // This allows an alternative site title for SEO schema.
  publisher: 'Publisher named GCN', // Organization name used for SEO schema
  siteDescription:
    'Portfolio of professional photographer Elizaberhseaside',
  ...
  author: 'Liza Biriukova', // Author for RSS author segment and SEO schema
  ...
  shortTitle: 'Elizabethseaside', // Used for App manifest e.g. Mobile Home Screen
  ...
  copyright: 'Copyright © 2019 Elizabethseaside', // Copyright string for the RSS feed
}
